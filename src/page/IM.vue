      ...
      serviceList:[
        ...
        },
        {
          ...
          list:[
            ...
            '支持好友验证机制，支持保证消息100%送达的回执机制',
            '支持离线消息推送，关掉APP仍能收到系统级提醒'
          ]
        },
        {
